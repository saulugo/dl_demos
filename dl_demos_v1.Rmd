...
dl.model.500e <- h2o.deeplearning(1:2,3,mydata.hex,epochs = 500)
dl.model.1000e <- h2o.deeplearning(1:2,3,mydata.hex,epochs = 1000)
gbm.model <- h2o.gbm(1:2,3,mydata.hex)
rf.model <- h2o.randomForest(1:2,3,mydata.hex)
nb.model <- h2o.naiveBayes(1:2,3,mydata.hex)
glm.model <- h2o.glm(1:2,3,mydata.hex,family= "multinomial")
...
plot.new()
par(mfrow=c(3,3))
plot_boundary("DL Model 500 epochs", dl.model.500e, mydata.hex, grid)
plot_boundary("DL Model 1000 epochs", dl.model.1000e, mydata.hex, grid)
...
plot_boundary("GLM Model", glm.model, mydata.hex, grid)
